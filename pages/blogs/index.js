...
<div className="flex flex-col min-h-screen">
  ...
  <div className="bg-gray-800">
    <div className="p-5 border-b border-gray-700 flex items-center justify-between">
      ...
      >
      <svg className="w-4 h-4 fill-current mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
      ...
      <circle cx="20" cy="20" r="16" stroke="#FFF" strokeWidth="8" fill="none" />
    </svg>
      <div className="inline-flex items-center text-gray-600">
        <svg className="w-5 h-5 fill-current mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 250.313 250.313">
        <path d="M244.186 214.604l-54.379-54.378c-.289-.289-.628-.491-.93-.76 10.7-16.231 16.945-35.66 16.945-56.554C205.822 46.075 159.747 0 102.911 0S0 46.075 0 102.911c0 56.835 46.074 102.911 102.91 102.911 20.895 0 40.323-6.245 56.554-16.945.269.301.47.64.759.929l54.38 54.38c8.169 8.168 21.413 8.168 29.583 0 8.168-8.169 8.168-21.413 0-29.582zm-141.275-44.458c-37.134 0-67.236-30.102-67.236-67.235 0-37.134 30.103-67.236 67.236-67.236 37.132 0 67.235 30.103 67.235 67.236s-30.103 67.235-67.235 67.235z"/>
      </svg>
        <svg className="w-5 h-5 fill-current mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 510 510">
    ...
    <div className="container mx-auto">
      <div className="flex flex-wrap py-8 flex-col sm:flex-row">
        <div className="w-32 h-32 rounded-full overflow-hidden  m-auto sm:m-0">
          <img style={{height:'inherit'}} src="https://www.shutterstock.com/image-photo/portrait-smiling-african-american-student-260nw-1194497215.jpg" />
        </div>
        <div className="sm:pl-10 sm:pt-4 flex-1">
          <div className="flex sm:justify-between sm:flex-row sm:flex-no-wrap justify-center flex-wrap mb-6">
            <div className="flex flex-wrap md:w-auto w-full md:mb-0 mb-4">
              <h2 className="text-white text-2xl w-full mb-3 text-center sm:text-left mt-4 sm:mt-0">Rezowanur Rahman Robin</h2>
              <div className="flex sm:w-auto w-full sm:justify-start justify-center">
                ...
                <span className="text-gray-600 mr-4 tracking-wider"><span className="text-gray-400">45</span> Following</span>
              </div>
    ...
    <div className="flex justify-center border-t border-gray-700 py-5">
      <a href="#" className="text-white mx-5">Articles</a>
    </div>
  </div>
      ...
      <div className="flex flex-wrap md:-mx-3">
        
        {
         blogs.length>0 && blogs.map((blog)=>{
            return (
              <div className="md:w-1/2 px-3 mb-6 w-full" key={blog.title}>
          <div className="flex w-full h-full flex-wrap bg-gray-800 overflow-hidden rounded">
            <div className="w-2/6">
              <img className="object-cover h-full w-full" src={blog.image} />
            </div>
            <div className="w-4/6 p-5">
              <Link href={`/blogs/${blog.title}`} >
              <h2 className="text-white leading-normal text-lg hover:text-blue-500">{blog.title}</h2>
              </Link>
              <p className='text-white  text-sm' > {blog.content?.slice(0,100)}...</p>
